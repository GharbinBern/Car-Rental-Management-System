"""
API Core Middleware Module

This module contains foundational middleware components that process all API requests and responses.
These middleware functions provide essential cross-cutting concerns for the entire FastAPI application.
"""
